...
// Backend returnerar { url, filename, mimeType } från
// /portal/documents/:id/download — URL:en är giltig i 5 min och kräver inte
// någon Authorization-header (Cloudflare-signaturen ligger i query-stringen).
//
...
// bort från SPA:n när PDF:en visas inline.
