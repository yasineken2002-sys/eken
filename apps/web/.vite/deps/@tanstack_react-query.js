import { require_jsx_runtime } from './chunk-NGE56BNF.js'
  ...
  ((_a5 = class extends Removable {
        ...
        if (!this.observers.length) {
          if (__privateGet(this, _retryer)) {
            if (
              ...
              __privateMethod(this, _Query_instances, isInitialPausedFetch_fn).call(this)
            ) {
    ...
    async fetch(options, fetchOptions) {
      ...
      if (
        ...
        this.state.fetchMeta !== ((_c = context.fetchOptions) == null ? void 0 : _c.meta)
      ) {
        __privateMethod(this, _Query_instances, dispatch_fn).call(this, {
          type: 'fetch',
      ...
      try {
        ...
        this.setData(data)
        ;(_f = (_e = __privateGet(this, _cache).config).onSuccess) == null
          ? void 0
          : _f.call(_e, data, this)
        ;(_h = (_g = __privateGet(this, _cache).config).onSettled) == null
          ? void 0
          : _h.call(_g, data, this.state.error, this)
        return data
      } catch (error) {
        ...
        ;(_j = (_i = __privateGet(this, _cache).config).onError) == null
          ? void 0
          : _j.call(_i, error, this)
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction =
        (_c =
          (_b = (_a13 = context.fetchOptions) == null ? void 0 : _a13.meta) == null
            ? void 0
            : _b.fetchMore) == null
          ? void 0
          : _c.direction
...
var Mutation =
  ((_a7 = class extends Removable {
    ...
    continue() {
      var _a13
      return (
        ((_a13 = __privateGet(this, _retryer2)) == null ? void 0 : _a13.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
    ...
    async execute(variables) {
      ...
      try {
        ...
        await ((_d = (_c = __privateGet(this, _mutationCache).config).onSuccess) == null
          ? void 0
          : _d.call(_c, data, variables, this.state.context, this, mutationFnContext))
        await ((_f = (_e = this.options).onSuccess) == null
          ? void 0
          : _f.call(_e, data, variables, this.state.context, mutationFnContext))
        await ((_h = (_g = __privateGet(this, _mutationCache).config).onSettled) == null
          ? void 0
          : _h.call(
              _g,
              data,
        ...
        await ((_j = (_i = this.options).onSettled) == null
          ? void 0
          : _j.call(_i, data, null, variables, this.state.context, mutationFnContext))
        __privateMethod(this, _Mutation_instances, dispatch_fn2).call(this, {
          type: 'success',
          data,
        })
...
var MutationObserver =
  ((_a9 = class extends Subscribable {
    ...
    setOptions(options) {
      ...
      if (
        ...
        ((_a13 = __privateGet(this, _currentMutation)) == null ? void 0 : _a13.state.status) ===
        'pending'
      ) {
  ...
  (updateResult_fn = function () {
    var _a13
    const state =
      ((_a13 = __privateGet(this, _currentMutation)) == null ? void 0 : _a13.state) ??
      getDefaultState2()
        ...
        if ((action == null ? void 0 : action.type) === 'success') {
          ...
          try {
            ;(_d = (_c = __privateGet(this, _mutateOptions)).onSettled) == null
              ? void 0
              : _d.call(_c, action.data, null, variables, onMutateResult, context)
          } catch (e) {
            void Promise.reject(e)
          }
          ...
          try {
            ;(_h = (_g = __privateGet(this, _mutateOptions)).onSettled) == null
              ? void 0
              : _h.call(_g, void 0, action.error, variables, onMutateResult, context)
          } catch (e) {
            void Promise.reject(e)
          }
        }
...
var QueriesObserver =
  ...
  (findMatchingObservers_fn = function (queries) {
    ...
    queries.forEach((options) => {
      ...
      const match =
        (_a13 = prevObserversMap.get(defaultedOptions.queryHash)) == null ? void 0 : _a13.shift()
  ...
  (notify_fn3 = function () {
    ...
    if (this.hasListeners()) {
      ...
      const newResult = __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(
        this,
        newTracked,
        (_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine,
      )
...
var QueryClient =
  ((_a12 = class {
    ...
    getQueryData(queryKey) {
      ...
      return (_a13 = __privateGet(this, _queryCache).get(options.queryHash)) == null
        ? void 0
        : _a13.state.data
    }
...
var ensurePreventErrorBoundaryRetry = (options, errorResetBoundary, query) => {
  const throwOnError =
    (query == null ? void 0 : query.state.error) && typeof options.throwOnError === 'function'
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  ;(_d =
    (_c = client.getDefaultOptions().queries) == null ? void 0 : _c._experimental_afterQuery) ==
  null
    ? void 0
