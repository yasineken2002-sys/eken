...
export function LeaseForm({
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-5">
      ...
      {isActiveLock && (
        <div className="flex items-start gap-2.5 rounded-xl border border-gray-300 bg-gray-200/70 px-3.5 py-3">
          <Lock size={15} strokeWidth={2} className="mt-0.5 shrink-0 text-gray-500" />
      ...
      {mode === 'create' && (
        <p className="rounded-lg bg-gray-200/70 px-3.5 py-2.5 text-[12.5px] text-gray-700">
