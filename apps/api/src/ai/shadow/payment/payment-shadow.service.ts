...
export function byggBetalningsprompt(
  ...
  return [
    ...
    '  Du kan inte dela beloppet på flera fordringar. Om betalningen överstiger vald',
    '  kandidats utestående med mer än 1 kr, välj INGEN; namnträff gör inte beloppet giltigt.',
    ...
    '  Det finns ingen minsta andel för en delbetalning. När hela namnet stämmer, texten',
    '  beskriver betalning eller hyra och rätt avi kan skiljas ut, välj den avin även om',
    '  bara en liten del betalas. Beloppsavvikelsen mäter då återstående skuld, inte fel.',
