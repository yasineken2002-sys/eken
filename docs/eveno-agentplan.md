...
| 7 | G2 delegationer + "Gör alltid detta" + preferenser | 6 | hyresvärden kan delegera och se vad systemet tror om hen | **DELVIS** `a9e74b8` — modellen, grunden och grinden finns ([#801](https://github.com/yasineken2002-sys/eken/pull/801)); **föds inte ur inkorgen än, och ingen sida** |
...
**Delegationsgrunden finns sedan 2026-09-05** ([#801](https://github.com/yasineken2002-sys/eken/pull/801), etapp 7). `AiToolExecution`
...
**BYGGT 2026-09-05** ([#801](https://github.com/yasineken2002-sys/eken/pull/801)). `AiDelegation` + `AiDelegationEvent`, den senare med
