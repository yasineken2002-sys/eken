...
Markör och varje skyddad effekt tar samma organisationsbundna advisory transaction lock i namespace payment-freshness innan avi-, konto- eller sekvenslås. Effekterna tar delat lås, markören exklusivt, så oberoende effekter behöver inte serialiseras av färskhetsgrinden. Inget organisationsradlås införs. Efter låsväntan läses organisationen i ett separat ReadCommitted-statement. Root-klient och annan isolering avvisas av effektporten. Vinnande markör stoppar effekten; vinnande effekt får committa och markören blockerar senare effekter. Låset bevisar inte global frihet från befintliga avi/sekvens-deadlocks.
