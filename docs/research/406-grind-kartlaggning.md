...
| fall                               | facit | BM25 topp-3 (score/cov)                                           | cosine | grind               | 2 § rank/score | 4 a § rank/score | 2 § > 4 a §? | domarens fönster (fused topp-3) |
| ---------------------------------- | ----- | ----------------------------------------------------------------- | ------ | ------------------- | -------------- | ---------------- | ------------ | ------------------------------- |
| `paminnelseavgift-ratten`          | 2 §   | hyresl:20 18.7/0.71<br>bostad:16 13.5/0.43<br>hyresl:55 11.7/0.57 | 0.506  | kandidat            | 4 / 9.69       | 17 / 6.92        | JA           | bostad · hyresl · **2 §**       |
| `paminnelseavgift-lagens-egna-ord` | 2 §   | inkass:2 15.7/0.75<br>inkass:4 10.6/0.75<br>inkass:3 6.6/0.50     | 0.629  | kandidat            | 1 / 15.67      | — / 0.00         | JA           | **2 §** · **4 §** · **3 §**     |
| `paminnelseavgift-taket`           | 4 §   | inkass:2 6.7/0.50<br>inkass:4 5.5/0.50<br>hyresl:55 e 1.8/0.50    | 0.417  | miss:weak-retrieval | 1 / 6.73       | — / 0.00         | JA           | **4 §** · **2 §** · bostad      |
| `paminnelseavgift-avtalskravet`    | 2 §   | inkass:2 7.0/0.50<br>inkass:6 6.3/0.50<br>bostad:14 6.1/0.50      | 0.465  | miss:weak-retrieval | 1 / 7.03       | 35 / 1.91        | JA           | **2 §** · bostad · bostad       |
| `paminnelseavgift-vad-galler`      | 2 §   | inkass:2 6.7/0.33<br>inkass:4 6.6/0.67<br>hyresl:55 5.2/0.67      | 0.444  | miss:weak-retrieval | 1 / 6.73       | 125 / 1.00       | JA           | **2 §** · bostad · bostad       |
...
| `paminnelseavgift-hogre-i-avtal`   | 6 §   | inkass:2 9.1/0.29<br>hyresl:38 8.8/0.57<br>inkass:4 8.7/0.29      | 0.409  | miss:weak-retrieval | 1 / 9.13       | — / 0.00         | JA           | **2 §** · **4 §** · hyresl      |
...
| `besittningsskydd-andrahand-2ar`    | answerable    | 17.28/0.42 | 24.68/0.40 (+7.4)  | 25.03/0.40 (+7.8)  | 25.36/0.40 (+8.1)  | 17.29/0.42 (+0.0) |
| `besittningsskydd-lokal`            | answerable    | 9.51/0.43  | 14.04/0.56 (+4.5)  | 14.55/0.56 (+5.0)  | 14.61/0.56 (+5.1)  | 9.51/0.43 (+0.0)  |
...
| `hyra-forfallodag`                  | answerable    | 22.80/1.00 | 24.03/1.00 (+1.2)  | 23.86/1.00 (+1.1)  | 23.40/1.00 (+0.6)  | 22.79/1.00 (-0.0) |
...
| `storning-uppsagning`               | answerable    | 28.65/0.43 | 29.67/0.43 (+1.0)  | 30.08/0.43 (+1.4)  | 29.71/0.43 (+1.1)  | 28.67/0.43 (+0.0) |
| `andrahand-utan-samtycke`           | answerable    | 18.81/0.60 | 26.12/0.64 (+7.3)  | 26.45/0.64 (+7.6)  | 26.79/0.64 (+8.0)  | 18.83/0.60 (+0.0) |
| `hyreshojning-formkrav`             | answerable    | 6.82/0.50  | 8.48/0.75 (+1.7)   | 8.30/0.75 (+1.5)   | 7.25/0.75 (+0.4)   | 6.82/0.50 (+0.0)  |
...
| `B`        | besittningsskydd-lokal 9.51  | kravbrev-avgift 12.02/1.00                | **överlappar**    | **NEJ**              |
...
- Paritet mot produktionen (variant B): **max |Δscore| = 0, max |Δcoverage| = 0**, noll grindavvikelser (30 frågor × 427 chunkar).
